...
pub (crate) fn bid128_ext_fma (
    ptr_is_midpoint_lt_even: &mut i32,
    ptr_is_midpoint_gt_even: &mut i32,
    ptr_is_inexact_lt_midpoint: &mut i32,
    ptr_is_inexact_gt_midpoint: &mut i32,
    x: &BID_UINT128,
    y: &BID_UINT128,
    z: &BID_UINT128
    rnd_mode: u32) -> BID_UINT128 {

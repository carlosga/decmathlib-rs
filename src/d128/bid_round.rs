...
use crate::d128::bid_internal::{__mul_128x128_to_256, __mul_192x192_to_384, __mul_256x256_to_512, __mul_64x64_to_128MACH};
use crate::d128::dec128::{BID_UINT128, BID_UINT192, BID_UINT256, BID_UINT384, BID_UINT512, BID_UINT64};
...
pub (crate) fn bid_round256_58_76(
    ...
    if ind <= 18 {	// if 0 <= ind <= 18
        ...
        tmp64  = C.w[0];
        C.w[0] = C.w[0].wrapping_add(bid_midpoint128[(ind - 19) as usize].w[0]);
        if C.w[0] < tmp64 {
            C.w[1] += 1;
            if C.w[1] == 0x0 {
                C.w[2] += 1;
        ...
        tmp64  = C.w[1];
        C.w[1] = C.w[1].wrapping_add(bid_midpoint128[(ind - 19) as usize].w[1]);
        if C.w[1] < tmp64 {
            C.w[2] += 1;
            if C.w[2] == 0x0 {
                C.w[3] += 1;
        ...
        tmp64  = C.w[0];
        C.w[0] = C.w[0].wrapping_add(bid_midpoint192[(ind - 38) as usize].w[0]);
        if C.w[0] < tmp64 {
            C.w[1] += 1;
            if C.w[1] == 0x0u64 {
                C.w[2] += 1;
        ...
        tmp64  = C.w[1];
        C.w[1] = C.w[1].wrapping_add(bid_midpoint192[(ind - 38) as usize].w[1]);
        if C.w[1] < tmp64 {
            C.w[2] += 1;
            if C.w[2] == 0x0 {
                C.w[3] += 1;
        ...
        tmp64  = C.w[2];
        C.w[2] = C.w[2].wrapping_add(bid_midpoint192[(ind - 38) as usize].w[2]);
        if C.w[2] < tmp64 {
            C.w[3] += 1;
        }
    } else {	// if 58 <= ind <= 76 (actually 58 <= ind <= 74)
        tmp64 = C.w[0];
        C.w[0] = C.w[0].wrapping_add(bid_midpoint256[(ind - 58) as usize].w[0]);
        if C.w[0] < tmp64 {
            C.w[1] += 1;
            if C.w[1] == 0x0u64 {
                C.w[2] += 1;
        ...
        tmp64  = C.w[1];
        C.w[1] = C.w[1].wrapping_add(bid_midpoint256[(ind - 58) as usize].w[1]);
        if C.w[1] < tmp64 {
            C.w[2] += 1;
            if C.w[2] == 0x0 {
              C.w[3] += 1;
        ...
        tmp64 = C.w[2];
        C.w[2] = C.w[2].wrapping_add(bid_midpoint256[(ind - 58) as usize].w[2]);
        if C.w[2] < tmp64 {
            C.w[3] += 1;
        }
        C.w[3] = C.w[3].wrapping_add(bid_midpoint256[(ind - 58) as usize].w[3]);
    }

...
// dec_test!(bid128_is_finite, bid128_is_finite, -Infinity 0,);
// dec_test!(bid128_is_finite, bid128_is_finite, Infinity 0,);
// dec_test!(bid128_is_finite, bid128_is_finite, QNaN 0,);
// dec_test!(bid128_is_finite, bid128_is_finite, SNaN 0,);

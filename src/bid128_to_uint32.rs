...
pub (crate) fn bid128_to_uint32_rnint(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    ...
    || ((x.w[1]  & 0x6000000000000000u64) == 0x6000000000000000u64) {
        ...
        match q + exp {
            value if value > 10 => {	// x >= 10^10 ~= 2^33.2... (cannot fit in 32 bits)
                // set invalid flag
                *pfpsf |= StatusFlags::BID_INVALID_EXCEPTION;
                // return Integer Indefinite
                res = 0x80000000;
            ...
            value if value == 10 => {	// x = c(0)c(1)...c(9).c(10)...c(q-1)
        ...
        match q + exp {
            ...
            _ => {	// if (1 <= q + exp <= 10, 1 <= q <= 34, -33 <= exp <= 9)
                if x_sign != 0 {	// x <= -1
                    // set invalid flag
                    *pfpsf |= StatusFlags::BID_INVALID_EXCEPTION;
                    // return Integer Indefinite
                ...
                res = match exp {
                    value if value < 0 => {	// 2 <= q <= 34, -33 <= exp <= -1, 1 <= q + exp <= 10
                    ...
                    _ => {	// if (exp > 0) => 1 <= exp <= 9, 1 <= q < 9, 2 <= q + exp <= 10
                        // res = C * 10^exp (exact)
...
pub (crate) fn bid128_to_uint32_ceil(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    let res: u32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
    ...
    || ((x.w[1]  & 0x6000000000000000u64) == 0x6000000000000000u64) {
        ...
        if (q + exp) <= 0 {
            // n = +/-0.0...c(0)c(1)...c(q-1) or n = +/-0.c(0)c(1)...c(q-1)
            // return 0
            res = if x_sign != 0 { 0x00000000 }  else { 0x00000001 };
            return res;
        } else {	// if (1 <= q + exp <= 10, 1 <= q <= 34, -33 <= exp <= 9)
...
pub (crate) fn bid128_to_uint32_xceil(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    let res: u32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_uint32_int(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    let res: u32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_uint32_xint(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    let res: u32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_uint32_rninta(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    let res: u32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
            ...
            _ => {	// if (1 <= q + exp <= 10, 1 <= q <= 34, -33 <= exp <= 9)
                ...
                match exp {
                    value if value < 0 => {	// 2 <= q <= 34, -33 <= exp <= -1, 1 <= q + exp <= 10
                        ...
                        res = Cstar.w[0] as u32;	// always positive
...
pub (crate) fn bid128_to_uint32_xrninta(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> u32 {
    let res: u32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent

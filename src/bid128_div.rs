...
BID_UINT64 sign_x, sign_y, T, carry64, D, Q_high, Q_low, QX, PD, valid_y;
int_float fx, fy, f64;
...
if (!unpack_BID128_value(&sign_x, &exponent_x, &CX, x)) {
    ...
    if ((x.w[1] & 0x7800000000000000ull) == 0x7800000000000000ull) {
        ...
        {
            // return +/-Inf
            res.w[1] = ((x.w[1] ^ y.w[1]) & 0x8000000000000000ull) | 0x7800000000000000ull;
            res.w[0] = 0;
            BID_RETURN(res);
        }
    }
...
if (!unpack_BID64(&sign_x, &exponent_x, &CX.w[0], (x))) {
    ...
    if (((x)&0x7800000000000000ull) == 0x7800000000000000ull) {
        ...
        if ((((y)&0x7c00000000000000ull) != 0x7c00000000000000ull)) {
            ...
            res.w[1] = (((x) ^ (y)) & 0x8000000000000000ull) | 0x7800000000000000ull;
            res.w[0] = 0;
            BID_RETURN(res);
        }
    }
...
if (!unpack_BID64(&sign_x, &exponent_x, &CX.w[0], x)) {
    ...
    if ((x & 0x7800000000000000ull) == 0x7800000000000000ull) {
        ...
        if (((y.w[1] & 0x7c00000000000000ull) != 0x7c00000000000000ull)) {
            // otherwise return +/-Inf
            res.w[1] = ((x ^ y.w[1]) & 0x8000000000000000ull) | 0x7800000000000000ull;
            res.w[0] = 0;
            BID_RETURN(res);
        }
    }
...
if (!unpack_BID128_value(&sign_x, &exponent_x, &CX, x)) {
    ...
    if ((x.w[1] & 0x7800000000000000ull) == 0x7800000000000000ull) {
        ...
        {
            // return +/-Inf
            res.w[1] = ((x.w[1] ^ y) & 0x8000000000000000ull) | 0x7800000000000000ull;
            res.w[0] = 0;
            BID_RETURN(res);
        }
    }

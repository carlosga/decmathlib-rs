...
dec_test!(bid128_total_order_mag_058, bid128_total_order_mag, 0x78000000000000000000000000000001u128, "+Inf"                                , true);
dec_test!(bid128_total_order_mag_059, bid128_total_order_mag, "1E+40"                               , "9999999999999999999E+20"             , false);
dec_test!(bid128_total_order_mag_060, bid128_total_order_mag, "1E+40"                               , "100000000000000000001E+20"           , true);
dec_test!(bid128_total_order_mag_061, bid128_total_order_mag, "9999999999999999999E+20"             , "1E+40"                               , true);
dec_test!(bid128_total_order_mag_062, bid128_total_order_mag, "100000000000000000001E+20"           , "1E+40"                               , false);
dec_test!(bid128_total_order_mag_063, bid128_total_order_mag, "1E+20"                               , "1000000000000000E+5"                 , false);
dec_test!(bid128_total_order_mag_064, bid128_total_order_mag, "1E+20"                               , "1000000000000001E+5"                 , true);
dec_test!(bid128_total_order_mag_065, bid128_total_order_mag, "1000000000000000E+5"                 , "1E+20"                               , true);
dec_test!(bid128_total_order_mag_066, bid128_total_order_mag, "1000000000000001E+5"                 , "1E+20"                               , false);
dec_test!(bid128_total_order_mag_067, bid128_total_order_mag, "1E+40"                               , "100000000000000000000E+20"           , false);
dec_test!(bid128_total_order_mag_068, bid128_total_order_mag, "100000000000000000000E+20"           , "1E+40"                               , true);
dec_test!(bid128_total_order_mag_069, bid128_total_order_mag, 0x7c00314dc6448d9338c15b09ffffffffu128, 0x7c00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_mag_070, bid128_total_order_mag, 0xfc00314dc6448d9338c15b09ffffffffu128, 0xfc00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_mag_071, bid128_total_order_mag, 0x7c00314dc6448d9338c15b09ffffffffu128, 0x7c00314dc6448d9338c15b0a00000000u128, false);
dec_test!(bid128_total_order_mag_072, bid128_total_order_mag, 0xfc00314dc6448d9338c15b09ffffffffu128, 0xfc00314dc6448d9338c15b0a00000000u128, false);
dec_test!(bid128_total_order_mag_073, bid128_total_order_mag, 0x7c00314dc6448d9338c15b0a00000000u128, 0x7c00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_mag_074, bid128_total_order_mag, 0xfc00314dc6448d9338c15b0a00000000u128, 0xfc00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_mag_075, bid128_total_order_mag, 0x7e000000000000000000000000000000u128, 0x7c000000000000000000000000000000u128, true);
dec_test!(bid128_total_order_mag_076, bid128_total_order_mag, 0xfc000000000000000000000000000000u128, 0xfe000000000000000000000000000000u128, false);
dec_test!(bid128_total_order_mag_077, bid128_total_order_mag, 0xfe000000000000000000000000000000u128, 0xfc000000000000000000000000000000u128, true);
dec_test!(bid128_total_order_mag_078, bid128_total_order_mag, 0x7c000000000000000000000000000000u128, 0x7e000000000000000000000000000000u128, false);
dec_test!(bid128_total_order_mag_079, bid128_total_order_mag, 0x78000000000000000000000000000000u128, 0x78000000000000000000000000000000u128, true);
dec_test!(bid128_total_order_mag_080, bid128_total_order_mag, 0xf8000000000000000000000000000000u128, 0xf8000000000000000000000000000000u128, true);
dec_test!(bid128_total_order_mag_081, bid128_total_order_mag, 0x30400000000000000000000000000001u128, 0x2FFE314DC6448D9338C15B0A00000000u128, false);
dec_test!(bid128_total_order_mag_082, bid128_total_order_mag, 0xb0400000000000000000000000000001u128, 0xAFFE314DC6448D9338C15B0A00000000u128, false);

...
dec_test!(bid128_is_signaling_001, bid128_is_signaling, "-0"                                  , false);
dec_test!(bid128_is_signaling_002, bid128_is_signaling,  "0"                                  , false);
...
dec_test!(bid128_is_signaling_017, bid128_is_signaling, "-Infinity"                           , false);
dec_test!(bid128_is_signaling_018, bid128_is_signaling,  "Infinity"                           , false);
dec_test!(bid128_is_signaling_019, bid128_is_signaling,      "SNaN"                           , true);

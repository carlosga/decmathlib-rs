...
pub (crate) fn bid128_to_int32_ceil(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> i32 {
    let res: i32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int32_xceil(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> i32 {
    let res: i32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
            ...
            *pfpsf |= StatusFlags::BID_INEXACT_EXCEPTION;
            ...
            match exp {
                value if value < 0 => { // 2 <= q <= 34, -33 <= exp <= -1, 1 <= q + exp <= 10
                    ...
                    if x_sign != 0 && (is_midpoint_lt_even || is_inexact_gt_midpoint) {
                        Cstar.w[0] -= 1;
                    } else if x_sign == 0 && (is_midpoint_gt_even || is_inexact_lt_midpoint) {
                        Cstar.w[0] += 1;
                    } else {
                        // the result is already correct
                    }
...
pub (crate) fn bid128_to_int32_int(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> i32 {
    let res: i32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int32_xint(x: & BID_UINT128, pfpsf: &mut _IDEC_flags) -> i32 {
    let res: i32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int32_rninta(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> i32 {
    let res: i32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int32_xrninta(x : &BID_UINT128, pfpsf: &mut _IDEC_flags) -> i32  {
    let res: i32;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent

...
dec_test!(bid128_total_order_066, bid128_total_order, "1E+40"                               , "9999999999999999999E+20"             , false);
dec_test!(bid128_total_order_067, bid128_total_order, "1E+40"                               , "100000000000000000001E+20"           , true);
dec_test!(bid128_total_order_068, bid128_total_order, "-1E+40"                              , "-9999999999999999999E+20"            , true);
dec_test!(bid128_total_order_069, bid128_total_order, "-1E+40"                              , "-100000000000000000001E+20"          , false);
dec_test!(bid128_total_order_070, bid128_total_order, "9999999999999999999E+20"             , "1E+40"                               , true);
dec_test!(bid128_total_order_071, bid128_total_order, "100000000000000000001E+20"           , "1E+40"                               , false);
dec_test!(bid128_total_order_072, bid128_total_order, "-9999999999999999999E+20"            , "-1E+40"                              , false);
dec_test!(bid128_total_order_073, bid128_total_order, "-100000000000000000001E+20"          , "-1E+40"                              , true);
dec_test!(bid128_total_order_074, bid128_total_order, "1E+20"                               , "1000000000000000E+5"                 , false);
dec_test!(bid128_total_order_075, bid128_total_order, "-1E+20"                              , "-1000000000000000E+5"                , true);
dec_test!(bid128_total_order_076, bid128_total_order, "-1E+20"                              , "-1000000000000001E+5"                , false);
dec_test!(bid128_total_order_077, bid128_total_order, "1E+20"                               , "1000000000000001E+5"                 , true);
dec_test!(bid128_total_order_078, bid128_total_order, "1000000000000000E+5"                 , "1E+20"                               , true);
dec_test!(bid128_total_order_079, bid128_total_order, "-1000000000000000E+5"                , "-1E+20"                              , false);
dec_test!(bid128_total_order_080, bid128_total_order, "-1000000000000001E+5"                , "-1E+20"                              , true);
dec_test!(bid128_total_order_081, bid128_total_order, "1000000000000001E+5"                 , "1E+20"                               , false);
dec_test!(bid128_total_order_082, bid128_total_order, "-99999999999999999999999E+20"        , "-999999999999999999999999999999E+1"  , true);
dec_test!(bid128_total_order_083, bid128_total_order, "1E+1"                                , "1E+35"                               , true);
dec_test!(bid128_total_order_084, bid128_total_order, 0x7c00314dc6448d9338c15b09ffffffffu128, 0x7c00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_085, bid128_total_order, 0xfc00314dc6448d9338c15b09ffffffffu128, 0xfc00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_086, bid128_total_order, 0x7c00314dc6448d9338c15b09ffffffffu128, 0x7c00314dc6448d9338c15b0a00000000u128, false);
dec_test!(bid128_total_order_087, bid128_total_order, 0xfc00314dc6448d9338c15b09ffffffffu128, 0xfc00314dc6448d9338c15b0a00000000u128, true);
dec_test!(bid128_total_order_088, bid128_total_order, 0x7c00314dc6448d9338c15b0a00000000u128, 0x7c00314dc6448d9338c15b09ffffffffu128, true);
dec_test!(bid128_total_order_089, bid128_total_order, 0xfc00314dc6448d9338c15b0a00000000u128, 0xfc00314dc6448d9338c15b09ffffffffu128, false);
dec_test!(bid128_total_order_090, bid128_total_order, 0x7c000000000000000000000000000000u128, 0x7e000000000000000000000000000000u128, false);
dec_test!(bid128_total_order_091, bid128_total_order, 0x7e000000000000000000000000000000u128, 0x7c000000000000000000000000000000u128, true);
dec_test!(bid128_total_order_092, bid128_total_order, 0xfc000000000000000000000000000000u128, 0xfe000000000000000000000000000000u128, true);
dec_test!(bid128_total_order_093, bid128_total_order, 0xfe000000000000000000000000000000u128, 0xfc000000000000000000000000000000u128, false);
dec_test!(bid128_total_order_094, bid128_total_order, "11E+3"                               , "8E+2"                                , false);
dec_test!(bid128_total_order_095, bid128_total_order, "-12323E-21"                          , "-21324E-122"                         , true);
dec_test!(bid128_total_order_096, bid128_total_order, "1E+40"                               , "100000000000000000000E+20"           , false);
dec_test!(bid128_total_order_097, bid128_total_order, "100000000000000000000E+20"           , "1E+40"                               , true);
dec_test!(bid128_total_order_098, bid128_total_order, "-1E+40"                              , "-100000000000000000000E+20"          , true);
dec_test!(bid128_total_order_099, bid128_total_order, "-100000000000000000000E+20"          , "-1E+40"                              , false);
dec_test!(bid128_total_order_100, bid128_total_order, "+Inf"                                , "+Inf"                                , true);
dec_test!(bid128_total_order_101, bid128_total_order, 0x78000000000000000000000000000001u128, "+Inf"                                , true);
dec_test!(bid128_total_order_102, bid128_total_order, 1                                     , "+Inf"                                , true);
dec_test!(bid128_total_order_103, bid128_total_order, "-0"                                  , "-0E-2"                               , true);
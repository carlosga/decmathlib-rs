...
dec_test!(bid128_negate_003, bid128_negate, "-0"                                  , 0x30400000000000000000000000000000u128);
dec_test!(bid128_negate_004, bid128_negate,  "0"                                  , 0xb0400000000000000000000000000000u128);
...
dec_test!(bid128_negate_018, bid128_negate, "-Infinity"                           , 0x78000000000000000000000000000000u128);
dec_test!(bid128_negate_019, bid128_negate,  "Infinity"                           , 0xf8000000000000000000000000000000u128);
dec_test!(bid128_negate_020, bid128_negate,      "QNaN"                           , 0xfc000000000000000000000000000000u128);
dec_test!(bid128_negate_021, bid128_negate,      "SNaN"                           , 0xfe000000000000000000000000000000u128);

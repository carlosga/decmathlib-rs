...
pub (crate) fn bid128_to_int64_rnint(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> BID_SINT64 {
    ...
    || ((x.w[1]  & 0x6000000000000000u64) == 0x6000000000000000u64) {
        ...
        match q + exp {
            value if value > 19 => { // x >= 10^19 ~= 2^63.11... (cannot fit in BID_SINT64)
                // set invalid flag
                *pfpsf |= StatusFlags::BID_INVALID_EXCEPTION;
                // return Integer Indefinite
                res = 0x8000000000000000i64;
            ...
            value if value == 19 => { // x = c(0)c(1)...c(18).c(19)...c(q-1)
        ...
        match q + exp {
            ...
            _ => { // if (1 <= q + exp <= 19, 1 <= q <= 34, -33 <= exp <= 18)
                ...
                match exp {
                    ...
                    _ => { // if (exp>0) => 1 <= exp <= 18, 1 <= q < 18, 2 <= q + exp <= 19
...
pub (crate) fn bid128_to_int64_int(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> BID_SINT64 {
    let res: BID_SINT64;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int64_xint(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> BID_SINT64 {
    let res: BID_SINT64;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int64_rninta(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> BID_SINT64 {
    let res: BID_SINT64;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent
...
pub (crate) fn bid128_to_int64_xrninta(x: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> BID_SINT64 {
    let res: BID_SINT64;
    let x_sign: BID_UINT64;
    let x_exp: BID_UINT64;
    let exp: i32; // unbiased exponent

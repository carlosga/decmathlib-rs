...
use crate::bid_internal::{__add_128_128, __add_carry_in_out, __add_carry_out, __mul_128x128_low, __mul_128x128_to_256, __set_status_flags, __shr_128, __unsigned_compare_ge_128, bid_get_BID128_very_fast, BID_UI32FLOAT, BID_UINT128, BID_UINT256, BID_UINT32, BID_UINT64, unpack_BID128_value};
...
pub (crate) fn bid128_quantize(x: &BID_UINT128, y: &BID_UINT128, rnd_mode: u32, pfpsf: &mut _IDEC_flags) -> BID_UINT128 {
    ...
    let mut REM_H: BID_UINT128 = BID_UINT128::default();
    let mut C2N: BID_UINT128 = BID_UINT128::default();
    ...
    let mut tempx: BID_UI32FLOAT = BID_UI32FLOAT::default();

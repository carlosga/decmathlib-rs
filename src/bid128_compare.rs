...
use crate::bid_internal::{__mul_128x128_to_256, __mul_64x128_to192, __mul_64x128_to_192, BID_UINT128, BID_UINT192, BID_UINT256, MASK_INF, MASK_NAN, MASK_SIGN, MASK_SNAN, swap};
...
pub (crate) fn bid128_quiet_not_greater(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
    ...
    if (x.w[1] & MASK_INF) == MASK_INF {
        ...
        return if (x.w[1] & MASK_SIGN) == MASK_SIGN {
            res = true;
            res
        } else { // x is pos infinity, it is greater, unless y is positive infinity => return y!=pos_infinity
            res = ((y.w[1] & MASK_INF) == MASK_INF) && ((y.w[1] & MASK_SIGN) != MASK_SIGN);
            res
        }
    } else if (y.w[1] & MASK_INF) == MASK_INF {
    ...
    if x_is_zero && y_is_zero {   // if both numbers are zero, neither is greater => return NOTGREATERTHAN
        res = true;
        return res;
    } else if x_is_zero {         // is x is zero, it is greater if Y is negative
        res = (y.w[1] & MASK_SIGN) != MASK_SIGN;
        return res;
    } else if y_is_zero {         // is y is zero, X is greater if it is positive
        res = (x.w[1] & MASK_SIGN) == MASK_SIGN;
        return res;
    }
    // OPPOSITE SIGN (CASE5)
...
pub (crate) fn bid128_quiet_not_less(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_greater(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_greater_equal(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_greater_unordered(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_less(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_less_equal(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_less_unordered(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_not_greater(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
...
pub (crate) fn bid128_signaling_not_less(x: &BID_UINT128, y: &BID_UINT128, pfpsf: &mut _IDEC_flags) -> bool {
    let res: bool;
    let exp_x: i32;
    let exp_y: i32;
    let mut diff: i32;
